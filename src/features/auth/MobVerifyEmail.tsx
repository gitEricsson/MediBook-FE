...
export default memo(function MobVerifyEmail() {
  ...
  return (
    <MobScreen bg={MB.bg}>
      <MobTopBar title="" back transparent />
      <form onSubmit={handleResend} style={{ flex: 1, width: '100%', maxWidth: 420, margin: '0 auto', padding: '8px 24px 24px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
